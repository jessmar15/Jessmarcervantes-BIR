...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto"><li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="logout.php" style="color: #fff;"><b>
  ...
  <div class="main-content">
    <div class="container">
      <h1><center>Welcome to BIR RDO 057</center></h1><br>
      <div class="col-lg-12">
        <?php
        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card" style="background-color: #007bff; color: #fff">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h1><?php echo $row['total_employees']; ?></h1>
                    </div>
                  </div>
                </div>
              </div>
            ...
            // SQL query to count records in the timein table for today's date
            $sql2 = "SELECT COUNT(*) AS total_records FROM timein WHERE DATE(date) = :today_date";
            
            // Prepare the SQL statement
            $stmt2 = $conn->prepare($sql2);
            
            // Bind the parameter
            $stmt2->bindParam(':today_date', $todayDate);
            ...
            ?>
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card" style="background-color: #28a745; color: #fff">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h1><?php echo $row2['total_records']; ?></h1>
                    </div>
                  </div>
                </div>
              </div>
