...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "
    SELECT 
        e.firstname, e.lastname, e.department, i.date as date, i.time_in, o.time_out
    FROM 
        employee e
    LEFT JOIN 
    ...
    if ($stmt->rowCount() > 0) {
        ...
        <div id='results'>
          ...
          <h5>Department: &nbsp;&nbsp;&nbsp;" . htmlspecialchars($employee['department']) . "</h5>
          <h6>Date Range: &nbsp;&nbsp;&nbsp;&nbsp;" . htmlspecialchars($startDate) . " to " . htmlspecialchars($endDate) . "</h6>
